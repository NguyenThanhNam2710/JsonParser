package com.example.lab3_jsonparser.loader;
...
import com.example.lab3_jsonparser.adapter.RVAdapter;
import com.example.lab3_jsonparser.model.Detail;
...
public class GetLoader extends AsyncTask<String, Integer, List<String>> {
    ...
    protected void onPostExecute(List<String> s) {
        ...
        RVAdapter mAdapter = new RVAdapter(dataList, context);
